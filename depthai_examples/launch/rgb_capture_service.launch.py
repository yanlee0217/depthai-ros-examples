...
def generate_launch_description():
    ...
    default_rviz = os.path.join(get_package_share_directory('depthai_examples'),'rviz', 'stereoPointCloud.rviz')
    ...
    #=============================================================#
    ## Generate Launch Descriptions and ROS Param action servers ##
    ...
    capture_node = launch_ros.actions.Node(
            package='depthai_examples', executable='rgb_capture_service',
            output='screen',
